...
import { headerBackLogoMenuProps } from './header_back_logo_menu.props';

/**
 * Header that appears on many screens. Will hold navigation buttons and screen title.
 */
export function HeaderBackLogoMenu(props: headerBackLogoMenuProps) {
    ...
    <View
      ...
      <TouchableOpacity
        ...
        <Image
          ...
          style={{ height: 39, width: 88, flex: 1 }}
          resizeMode="contain"
        />
      </TouchableOpacity>
      <TouchableOpacity
