import { Center, CSSObject, Flex, Icon, Image, Text } from '@chakra-ui/react';
import { Device } from '../../components/Device';
import { IButtonIconProps } from './LightDevice';



export const LightDevice2x: React.FC<IButtonIconProps> = (props) => {
  return (
    <Flex sx={CONTAINER}>
      <Flex sx={FLEX}>
        <Device
          ...
          controlButton={[
            {
              ...
              tooltip: props.buttonOne === false ? 'کلید روشن' : 'کلید خاموش',
            },
          ]}
        />
      </Flex>
